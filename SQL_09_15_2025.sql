...
final_trips as (
    select t.id, t.client_id, t.driver_id, t.status, t.request_at
    from unbanned_driver_trips t
    join unbanned_users u
    on t.client_id = u.users_id
),

-- cancellation_rate -> (number of cancelled request) / (total number of requests)
...
select request_at as "Day", round((Cancelled_count::Numeric / total_request), 2) as "Cancellation Rate"
from temp_res
